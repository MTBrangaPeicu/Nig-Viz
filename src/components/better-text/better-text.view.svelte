...
<div class="mgui-relative mgui-w-full">
  <textarea
    bind:this={textarea}
    bind:value={value}
    oninput={updateValue}
    ...
    class="mgui-textarea mgui-w-full mgui-min-h-[160px] mgui-resize-y mgui-p-3 mgui-border mgui-border-gray-300 mgui-rounded mgui-text-gray-800 mgui-text-base focus:mgui-outline-none focus:mgui-border-blue-500"
  ></textarea>
</div>
